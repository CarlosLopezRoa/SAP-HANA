...
if (g_pdet == "TODOS"){
 ...
 if(g_cross_trend=="cross"){
   ...
   //cancelaciones
   SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TODOS.setVisible(true);
   ...
   //TEXT_INFO.setText("g_pdet-todos,g_cross_trend(Cancel.)="+g_pdet+","+g_cross_trend);
   //TEXT_INFO.setText("g_pdet-todos(Cancel.)="+g_cross_trend);

 }

 if(g_cross_trend=="trend"){
	//TEXT_INFO.setText("g_pdet-tv-trend(Cancel.)="+g_cross_trend);
...
if (g_pdet == "TELEVISION"){
 ...
 if(g_cross_trend=="cross"){
   ...
   SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_INTERNET.setVisible(false);
   SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TELEFONIA.setVisible(false);
   SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TELE.setVisible(true);
   ...
   //TEXT_INFO.setText("g_pdet-tv,g_cross_trend(Cancel.)="+g_pdet+","+g_cross_trend);
   //TEXT_INFO.setText("g_pdet-tv(Cancel.)="+g_cross_trend);
 }
 if(g_cross_trend=="trend"){
	//TEXT_INFO.setText("g_pdet-tv-trend(Cancel.)="+g_cross_trend);
   //ventas
 ...
 // 	 dia_ant_dia_primero_tv = "30";
  ...
  //RC - 01/06/2015
   ...
   //Pérdidas:
   CHART_1.setDataSelection({
	"[Measures]": ["NO_CANCELACIONES_VIDEO", "NO_CANCELACIONES_PM_VIDEO", "NO_CANCELACIONES_PY_VIDEO"]
   });
...
if (g_pdet == "TELEFONIA"){
 ...
 if(g_cross_trend=="cross"){
    ...
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TODOS.setVisible(false);
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_INTERNET.setVisible(false);
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TELEFONIA.setVisible(true);
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TELE.setVisible(false);
   ...
   //TEXT_INFO.setText("g_pdet-telef,g_cross_trend(Cancel.)="+g_pdet+","+g_cross_trend);
   //TEXT_INFO.setText("g_pdet-telef(Cancel.)="+g_cross_trend);
 }
 if(g_cross_trend=="trend"){
	//TEXT_INFO.setText("g_pdet-telef-trend(Cancel.)="+g_cross_trend);
   //ventas
   SIMPLECROSSTAB_SERVICIOS_VENTAS_TODOS.setVisible(false);
   SIMPLECROSSTAB_SERVICIO_VENTAS_TELE.setVisible(false);
   SIMPLECROSSTAB_SERVICIO_VENTAS_TELEFONIA.setVisible(false);
 ...
 // 	 dia_ant_dia_primero_tele = "30";
  ...
  //RC - 01/06/2015
   ...
   //Pérdidas:
   CHART_1.setDataSelection({
	"[Measures]": ["NO_CANCELACIONES_TELEFONIA", "NO_CANCELACIONES_PM_TELEFONIA", "NO_CANCELACIONES_PY_TELEFONIA"]
   });
...
if (g_pdet == "INTERNET"){
 ...
 if(g_cross_trend=="cross"){
    ...
    //perdidas
    SIMPLECROSSTAB_SERVICIOS_PERDIDAS_TODOS.setVisible(true);
    SIMPLECROSSTAB_SERVICIOS_PERDIDAS_TELE.setVisible(false);
    SIMPLECROSSTAB_SERVICIOS_PERDIDAS_TELEFONIA.setVisible(false);
    SIMPLECROSSTAB_SERVICIOS_PERDIDAS_INTERNET.setVisible(false);
    ...
    //cancelaciones
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TODOS.setVisible(false);
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_INTERNET.setVisible(true);
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TELEFONIA.setVisible(false);
    SIMPLECROSSTAB_REG_SERVICIOS_CANCELACIONES_TELE.setVisible(false);
   ...
   //TEXT_INFO.setText("g_pdet-inet,g_cross_trend(Cancel.)="+g_pdet+","+g_cross_trend);
    //TEXT_INFO.setText("g_pdet-inet(Cancel.)="+g_cross_trend);
 }
 if(g_cross_trend=="trend"){
	//TEXT_INFO.setText("g_pdet-telef-trend(Cancel.)="+g_cross_trend);
   //ventas
 ...
 // 	 dia_ant_dia_primero_inet = "30";
  ...
  //RC - 01/06/2015
   ...
   //Pérdidas:
   CHART_1.setDataSelection({
	"[Measures]": ["NO_CANCELACIONES_INTERNET", "NO_CANCELACIONES_PM_INTERNET", "NO_CANCELACIONES_PY_INTERNET"]
   });
